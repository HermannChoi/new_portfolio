    ...
    >
      ...
      {isEnglish ? (
        <p css={pStyle}>
          ...
          goal is to create a <span css={highlightP}>seamless experience</span>{" "}
          where the user feels <span css={highlightP}>fully integrated</span>{" "}
          with the service, as if they are one with the site. I focus on the
          details, always thinking about how to enhance{" "}
          <span css={highlightP}>user satisfaction</span>, and craft the code
          with precision to ensure the product itself serves its purpose{" "}
          <span css={highlightP}>effectively</span>.
        </p>
      ) : (
        <p css={pStyle}>
